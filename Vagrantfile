...
BOX=[
	...
	{ :name => 'fed-book',         :image => f21_image,  :manifest => 'bookkeeping/simple.pp', :memory => big_memory },
	...
	{ :name => 'deb-spark',        :image => deb7_image, :manifest => 'spark/yarn-simple.pp', :memory => big_memory },
	{ :name => 'deb-spark-hdfs',   :image => deb7_image, :manifest => 'spark/yarn-cluster.pp', :memory => daemon_memory },
	{ :name => 'deb-spark-yarn',   :image => deb7_image, :manifest => 'spark/yarn-cluster.pp', :memory => daemon_memory },
	{ :name => 'deb-spark-node',   :image => deb7_image, :manifest => 'spark/yarn-cluster.pp', :memory => node_memory },
	{ :name => 'deb-spark-frontend', :image => deb7_image, :manifest => 'spark/yarn-cluster.pp', :memory => node_memory },
        { :name => 'deb-hamaster1',    :image => deb7_image, :manifest => 'ha.pp', :memory => daemon_memory },
        { :name => 'deb-hamaster2',    :image => deb7_image, :manifest => 'ha.pp', :memory => daemon_memory },
        { :name => 'deb-hanode',       :image => deb7_image, :manifest => 'ha.pp', :memory => node_memory },
]
DOMAIN='vagrant'
NETWORK='192.168.42'
INITIAL_IP=101
