...
fed fed-plain $(feds) fed-hive fed-hbase $(feds_hive) fed-acc $(feds_acc) deb deb-plain $(debs) deb-hive deb-hbase $(debs_hive) hive-mysql hive-postgresql deb-acc $(debs_acc) deb-oozie oozie-mysql oozie-postgresql:
	vagrant up $@
